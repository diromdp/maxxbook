...
const SlideSubCategories = dynamic(() => import('@/components/component/slideSubCategories'), {
    ssr: false,
})
const ResultShowID = dynamic(() => import('@/components/component/resultbyid'), {
    ssr: false,
})
...
const SingleCategory = ({detailCategory, slug, locale}) => {
    ...
    return (
        <div className="categories-page">
            <div className="screen-layer min-h-screen px-[16px] lg:px-[24px]">
                <BreadCumb menu={menu} />
